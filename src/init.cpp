...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: potcoin.conf)") + "\n";
    if (hmm == HMM_BITCOIND)
    {
#if !defined(WIN32)
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: potcoind.pid)") + "\n";
    ...
    strUsage += "\n" + _("RPC SSL options: (see the wiki.potcoin.com for SSL setup instructions)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (pwalletMain)
        GeneratePotcoins(GetBoolArg("-staking", true), pwalletMain, GetArg("-genproclimit", 1));
#endif
