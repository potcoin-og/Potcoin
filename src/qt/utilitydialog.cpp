    ...
    ui(new Ui::AboutDialog)
{
    ...
    tr("Copyright") + QString(" &copy; 2014-%1 ").arg(COPYRIGHT_YEAR) + tr("The Potcoin Core developers")
        );
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("Potcoin Core") + " " + tr("version") + " " +
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("Potcoin Core is shutting down...") + "<br /><br />" +
