...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Potcoin address (e.g. PdXd6m9nZ6GsUA6ZXLJjiyuKeS3vvsS7NX)"));
#endif
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("potcoin://", Qt::CaseInsensitive))
    {
        uri.replace(0, 10, "potcoin:");
    }
...
{
    QString ret = QString("potcoin:%1").arg(info.address);
    int paramCount = 0;
